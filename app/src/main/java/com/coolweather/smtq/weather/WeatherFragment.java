package com.coolweather.smtq.weather;
...
import com.coolweather.smtq.api.BaseWeatherResponse;
import com.coolweather.smtq.base.BaseContentFragment;
import com.coolweather.smtq.location.RxLocation;
import com.coolweather.smtq.model.HeWeather5;
import com.coolweather.smtq.ui.GirlActivity;
import com.coolweather.smtq.util.ACache;
import com.coolweather.smtq.util.SettingsUtil;
import com.coolweather.smtq.util.ShareUtils;
import com.coolweather.smtq.util.TTSManager;
import com.coolweather.smtq.util.TimeUtils;
import com.coolweather.smtq.util.WeatherUtil;
import com.coolweather.smtq.weather.adapter.WeatherAdapter;
...
public class WeatherFragment extends BaseContentFragment {
    ...
    protected void initViews() {
        ...
        ((GirlActivity) getActivity()).initDrawer(mToolbar);
