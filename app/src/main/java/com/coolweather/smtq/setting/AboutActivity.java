package com.coolweather.smtq.setting;
...
import com.coolweather.smtq.BuildConfig;
import com.coolweather.smtq.R;
import com.coolweather.smtq.base.BaseActivity;
import com.coolweather.smtq.util.FileUtil;
import com.coolweather.smtq.util.ShareUtils;
import com.coolweather.smtq.util.SimpleSubscriber;
import com.coolweather.smtq.util.UpdateUtil;
import com.coolweather.smtq.util.WebUtils;
...
import static com.coolweather.smtq.util.FileUtil.getFileDir;
...
public class AboutActivity extends BaseActivity {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_web_home:
                WebUtils.openInternal(this, "https://github.com/zzzengxiaoxian/weathercool");
                break;
            ...
            case R.id.btn_share_app:
                ShareUtils.shareText(this, "来不及了，赶紧上车！https://github.com/zzzengxiaoxian/weathercool");
                break;
        }
    }
    ...
    private void feedBack() {
        Intent intent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                "mailto", "https://github.com/zzzengxiaoxian/weathercool", null));
        intent.putExtra(Intent.EXTRA_EMAIL, "https://github.com/zzzengxiaoxian/weathercool");
